...
class Giphy(object):
    ...
    # Alex changed to expose weirdness.
    def translate(self, term=None, phrase=None, strict=False, rating=None, weirdness=0):
        """
        ...
        params = {'s': (term or phrase), 'weirdness': weirdness}
        if rating:
            params.update({'rating': rating})
